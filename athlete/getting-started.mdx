---
title: "Getting Started as an Athlete in FocusFlow"
...
| `age` / `birthDate` | Age in years, or date of birth in `YYYY-MM-DD` format |
| `biologicalSex` | `MALE` or `FEMALE` — used for body-composition formulas |
...
<CardGroup cols={2}>
  <Card title="Workout (Entrenar)" icon="dumbbell">
  ...
  <Card title="Calendar (Calendario)" icon="calendar">
  ...
  <Card title="Progress (Mi Progreso)" icon="chart-line">
  ...
  <Card title="Check-in (Revisión Semanal)" icon="clipboard-check">
  ...
  <Card title="Gallery (Galería)" icon="images">
  ...
  <Card title="Profile (Ajustes)" icon="user">
